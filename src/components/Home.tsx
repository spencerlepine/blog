        ...
        <div className="container">
          <div className="row">
            <div className="col col--9 col--offset-1">
              <h1 className="hero__title">👋 I'm Spencer, a software engineer.</h1>
              <p className="hero__subtitle">Welcome to my development playground.</p>
            </div>
          </div>
        </div>
      </div>
...
// Default export for plugins/recent-blog-posts.js
export default Home;
